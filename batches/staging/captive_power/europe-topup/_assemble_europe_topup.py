"""Assemble the europe-topup captive-power canonical staging JSONs from shard results.

Run from this directory:  python _assemble_europe_topup.py

Reads  shard_results/shard_*.json    (1 shard, 1 terminal)
