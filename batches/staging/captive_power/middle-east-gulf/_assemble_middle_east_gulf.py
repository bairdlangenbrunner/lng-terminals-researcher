"""Assemble the Middle East/Gulf captive-power canonical staging JSONs from shard results.

Run from this directory:  python _assemble_middle_east_gulf.py

Reads  shard_results/shard_*.json    (5 primary shards, 34 terminals)
