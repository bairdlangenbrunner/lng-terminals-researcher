"""Assemble the americas-gap captive-power canonical staging JSONs from shard results.

Run from this directory:  python _assemble_americas_gap.py

Reads  shard_results/shard_*.json    (23 primary shards, 156 terminals)
