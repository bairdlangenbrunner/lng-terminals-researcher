...
Last revised: 2026-06-24 (rev 2 — added domestic-only scope gate §3, upstream-oil-operator/associated-gas FLNG sweep §4.3, gem.wiki coverage cross-check §4.0b; from the africa-discovery follow-up corrections)
