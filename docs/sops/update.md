...
Rules:
- An existing URL may be dropped ONLY if it is proven dead per §7.2 (hard 404/410/DNS, or live-but-content-gone; a bot-block that fails even the Wayback check goes to `qa_review`, not a silent drop).
